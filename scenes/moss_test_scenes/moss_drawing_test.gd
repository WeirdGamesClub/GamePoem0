...
@onready var brushImage = Image.load_from_file("res://scenes/moss_test_scenes/test_brush.png")
@onready var brushImageRect = brushImage.get_used_rect()
...
func setup_image():
	...
	drawingImage.fill(Color(0.8, 0.6, 0.9))
